...
// Making range updation optional since current use case does not multiple ranges or editing them either
@optional
...
@property (nonatomic, assign) CGFloat scrollDecelartionRate;
